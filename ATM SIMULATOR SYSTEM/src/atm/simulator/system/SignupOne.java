...
public class SignupOne extends JFrame implements ActionListener {
    ...
    SignupOne() {
        ...
        mname.setBounds(100, 290, 200, 30);
        add(mname);

        mnameTextField = new JTextField();
        mnameTextField.setFont(new Font("Raleway", Font.BOLD, 14));
        mnameTextField.setBounds(300, 290, 400, 30);
        add(mnameTextField);
        ...
        female.setBounds(450, 390, 120, 30);
        add(female);
