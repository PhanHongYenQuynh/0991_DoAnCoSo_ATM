        ...
        if(ae.getSource()==back){
            ...
            try{
                ...
                if (ae.getSource() != back && balance < Integer.parseInt(amount)) {
                    ...
                    JOptionPane.showMessageDialog(null, "Rút tiền thành công là: "+amount+" VNĐ");
                    setVisible(false);
                    new Transactions(pinnumber).setVisible(true);
            }catch(Exception e){
